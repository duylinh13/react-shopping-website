  ...
  return (
    <div className=" bg-white">
      ...
      <span className="mt-[49px] mb-[53px] text-[18.5px] font-light leading-[1.51] text-[#111111]">
        ...
        개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 OO 사이버몰의 초기
        ...
        <br />
        <br />
        ③ “몰”은 전자상거래등에서의 소비자보호에 관한 법률, 약관의 규제에 관한
        법률, 전자거래기본법, 전자서명법, 정보통신망 이용촉진 및 정보보호 등에
        관한 법률, 방문판매 등에 관한 법률, 소비자보호법 등 관련법을 위배하지
        ...
        <br />
        <br />
        ⑤ “몰”이 약관을 개정할 경우에는 그 개정약관은 적용일자 이후에 체결되는
